...
#define CONFIG_IPADDR 172.21.186.199
#define CONFIG_SERVERIP 172.21.186.79
#define CONFIG_GATEWAYIP 172.21.186.1
...
#define CONFIG_SYS_PROMPT		"zhengguang@uboot # "	/* Monitor Command Prompt     */
